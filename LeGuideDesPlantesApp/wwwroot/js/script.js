...
//Select-2
    ...
    $(".blog-image").on("mouseenter", function () {
        $(".Arbres").addClass("Arbres-hvr");
    });

    $(".blog-image").on("mouseleave", function () {
        $(".Arbres").removeClass("Arbres-hvr");
    });
    ...
    $(".blog-image2").on("mouseenter", function () {
        $(".Aromatiques").addClass("Aromatiques-hvr");
    })

    $(".blog-image2").on("mouseleave", function () {
        $(".Aromatiques").removeClass("Aromatiques-hvr");
    })
    ...
    /*======================
            Sauvages
     =====================*/
    $(".blog-image3").on("mouseenter", function () {
        $(".Sauvages").addClass("Sauvages-hvr");
    })

    $(".blog-image3").on("mouseleave", function () {
        $(".Sauvages").removeClass("Sauvages-hvr");
    })
